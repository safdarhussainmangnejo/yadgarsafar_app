...
${
  ...
  `<p><u>This is underline text</u><span className=\"ql-cursor\">﻿</span></p>`
}
...
${
  /* eslint-disable-next-line */
  `<pre className=\"ql-syntax\" spellcheck=\"false\">cd project-folder\nnpm install\n</pre>`
}
...
${
  /* eslint-disable-next-line */
  `<pre className=\"ql-syntax\" spellcheck=\"false\"><span className=\"hljs-keyword\">var</span> React = <span className=\"hljs-built_in\">require</span>(<span className=\"hljs-string\">'react'</span>);\n<span className=\"hljs-keyword\">var</span> Markdown = <span className=\"hljs-built_in\">require</span>(<span className=\"hljs-string\">'react-markdown'</span>);\n\nReact.render(\n  <span className=\"hljs-tag\">&lt;<span className=\"hljs-name\">Markdown1</span> <span className=\"hljs-attr\">source</span>=<span className=\"hljs-string\">\"# Your markdown here\"</span> /&gt;</span>,\n  <span className=\"hljs-built_in\">document</span>.getElementById(<span className=\"hljs-string\">'content'</span>)\n);\n</pre>`
}
...
${
  /* eslint-disable-next-line */
  `<pre className=\"ql-syntax\" spellcheck=\"false\"><span className=\"hljs-function\"><span className=\"hljs-keyword\">function</span> <span className=\"hljs-title\">createStyleObject</span>(<span className=\"hljs-params\">classNames, style</span>) </span>{\n  <span className=\"hljs-keyword\">return</span> classNames.reduce(<span className=\"hljs-function\">(<span className=\"hljs-params\">styleObject, className</span>) =&gt;</span> {\n   <span className=\"hljs-keyword\">return</span> {...styleObject, ...style[className]};\n  }, {});\n }\n</pre>`
}
