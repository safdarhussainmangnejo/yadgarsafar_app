...
export default function AgencyList(props, variant) {
  ...
  console.log("Package ID in Agency: ", packageId)
  ...
  const companyName = users ? users.companyName : "No User";
  const headingMesg = companyName ? companyName.concat("'s Tour Packages") : "No Name"
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <UserMoreMenu onDelete={() => handleDeleteUser(users._id, _id)} userName={packageName} packageId={_id} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
