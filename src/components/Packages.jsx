...
const Packages = () => {
  ...
  const [departing, setDeparting] = useState(
    param.departing != "" ? param.departing : ""
  );
  ...
  const GroupTour = (event) => {
    ...
    checked ? setTourType(value) : setTourType(null);
  };
  ...
  const Sindh = (event) => {
    ...
    checked ? setProvince(value) : setProvince("");
  };
              ...
              <Box sx={{ minWidth: 120 }}>
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value={"Adventurous Tour"}>
                      Adventurous Tour
                    </MenuItem>
      ...
      <div className="row g-0">
        ...
        >
          ...
          <div style={{ paddingLeft: "25px" }}>
            <FormGroup>
              <FormControlLabel
                control={<Checkbox value="Group Tour" onChange={GroupTour} />}
                label="Group Tour"
              />
              <FormControlLabel
                control={
                  <Checkbox value="Private Tour" onChange={PrivateTour} />
                }
                label="Private Tour"
              />
            </FormGroup>
          ...
          <div style={{ paddingLeft: "25px" }}>
            <FormGroup>
              <FormControlLabel
                control={<Checkbox value="Sindh" onChange={Sindh} />}
                label="Sindh"
              />
              <FormControlLabel
                control={<Checkbox value="Punjab" onChange={Punjab} />}
                label="Punjab"
              />
              <FormControlLabel
                control={
                  <Checkbox value="Balochistan" onChange={Balochistan} />
                }
                label="Balochistan"
              />
              <FormControlLabel
                control={<Checkbox value="KPK" onChange={KPK} />}
                label="KPK"
              />
              <FormControlLabel
                control={
              ...
              <FormControlLabel
                control={
                  <Checkbox value="Azad Kashmir" onChange={AzadKashmir} />
                }
                label="Azad Kashmir"
              />
              <FormControlLabel
                control={<Checkbox value="Islamabad" onChange={Islamabad} />}
                label="Islamabad"
              />
            </FormGroup>
          </div>
